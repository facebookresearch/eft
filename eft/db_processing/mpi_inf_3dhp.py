...
if __name__ == '__main__':
    ...
    mpi_inf_3dhp_extract('/run/media/hjoo/disk/data/mpi_inf_3dhp', '/run/media/hjoo/disk/data/mpi_inf_3dhp/openpose', 'mpi_inf_output', 'train', extract_img=False, static_fits='/home/hjoo/codes/SPIN/data/static_fits')
