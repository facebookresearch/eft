...
def exportOursToSpin(cocoPose3DAll, out_path):
    ...
    out_file = os.path.join(out_path, '10-09-exempler_pennaction_validlimbs.npz')
...
if __name__ == '__main__':
    ...
    g_pose3D_pklFileName = '/run/media/hjoo/disk/data/cvpr2020_eft_researchoutput/10-09-exempler_pennaction/pose3DAnnot.pkl'      #No Shape
    with open(g_pose3D_pklFileName,'rb') as f:
